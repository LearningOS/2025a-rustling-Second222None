...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        */
        ...
        let value1 = scores.entry(team_1_name).or_insert(Team {goals_scored: 0, goals_conceded:0 });
        value1.goals_scored += team_1_score;
        value1.goals_conceded += team_2_score; 
        let value2 = scores.entry(team_2_name).or_insert(Team {goals_scored: 0, goals_conceded:0 });
